...
{
    [Fact]
    public void IsSpecuraiJob_描述包含Specurai標記_回傳True()
    {
        var job = new AgentJobInfo
        {
            JobId = Guid.NewGuid(),
            Name = "測試排程",
            Description = "[Specurai] 每日備份",
            IsEnabled = true
        };
    ...
    [Fact]
    public void IsSpecuraiJob_描述不包含Specurai標記_回傳False()
    {
        var job = new AgentJobInfo
        {
            JobId = Guid.NewGuid(),
    ...
    [Fact]
    public void IsSpecuraiJob_描述為Null_回傳False()
    {
        var job = new AgentJobInfo
        {
            JobId = Guid.NewGuid(),
