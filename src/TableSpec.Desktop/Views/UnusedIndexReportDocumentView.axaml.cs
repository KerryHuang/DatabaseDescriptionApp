...
/// 未使用索引報表文件視圖
/// </summary>
public partial class UnusedIndexReportDocumentView : UserControl
{
    // 嚴重度背景色
    ...
    public UnusedIndexReportDocumentView()
    {
        InitializeComponent();

        var dataGrid = this.FindControl<DataGrid>("UnusedIndexDataGrid");
        if (dataGrid != null)
        {
    ...
    {
        if (e.Row.DataContext is UnusedIndex index)
        {
