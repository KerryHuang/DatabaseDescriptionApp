...
/// <summary>
/// UnusedIndexReportDocumentViewModel 測試
/// </summary>
public class UnusedIndexReportDocumentViewModelTests
{
    [Fact]
    public void 設計時建構_DatabaseOptions應只有全部且預設選取全部()
    {
        var vm = new UnusedIndexReportDocumentViewModel();
    ...
    public async Task LoadDatabaseOptionsAsync_有服務_應以伺服器資料庫填充選項並選取全部()
    {
        ...
        var vm = new UnusedIndexReportDocumentViewModel(service);
